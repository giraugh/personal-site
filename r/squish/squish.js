...
const playerColours = ['#5468fe', '#fe4c55']
const playerSpawns = [
  [225, 150],
  [425, 150]
]
...
entities.push(new PhysicsEntity(200, 400, 300, 100, { colour: '#313131', kinematic: true, label: 'obstacle' }))
entities.push(new PhysicsEntity(200, 250, 300, 10, { colour: '#313131', kinematic: true, label: 'obstacle' }))
